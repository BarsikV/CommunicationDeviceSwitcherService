...
namespace CommunicationDeviceSwitcherService.ApplicationServices.CoreAudioApi
{
    internal class MMDevice
    {
        ...
        private PropertyStore GetPropertyInformation()
        {
            ...
            Marshal.ThrowExceptionForHR(_RealDevice.OpenPropertyStore(StgmAccess.STGM_READ, out propstore));
