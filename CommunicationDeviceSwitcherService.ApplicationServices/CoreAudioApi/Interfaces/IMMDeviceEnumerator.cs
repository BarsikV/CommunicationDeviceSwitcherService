...
namespace CommunicationDeviceSwitcherService.ApplicationServices.CoreAudioApi.Interfaces
{
    ...
    internal interface IMMDeviceEnumerator
    {
        ...
        /// </summary>
        /// <param name="dataFlow">The <see cref="DataFlow"/> direction for the endpoint devices in the collection.</param>
        /// <param name="stateMask">One or more <see cref="DeviceState"/> constants that indicate the state of the endpoints in the collection.</param>
        /// <param name="devices">The <see cref="IMMDeviceCollection"/> interface of the device-collection object.</param>
        /// <returns>An HRESULT code indicating whether the operation passed of failed.</returns>
        [PreserveSig]
        int EnumAudioEndpoints(
            [In] [MarshalAs(UnmanagedType.I4)] DataFlow dataFlow,
            [In] [MarshalAs(UnmanagedType.U4)] DeviceState stateMask,
        ...
        /// </summary>
        /// <param name="dataFlow">The <see cref="DataFlow"/> direction for the endpoint device.</param>
        /// <param name="role">The <see cref="Role"/> of the endpoint device.</param>
        /// <param name="device">The <see cref="IMMDevice"/> interface of the default audio endpoint device.</param>
        /// <returns>An HRESULT code indicating whether the operation passed of failed.</returns>
        [PreserveSig]
        int GetDefaultAudioEndpoint(
            [In] [MarshalAs(UnmanagedType.I4)] DataFlow dataFlow,
            [In] [MarshalAs(UnmanagedType.I4)] Role role,
